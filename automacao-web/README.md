...
cd prova-qa-asafe-escobar/automacao-web
```
...
A pipeline configurada em `.github/workflows/ci-web.yml` é executada automaticamente em:
- push na branch `main` (apenas quando arquivos de `automacao-web/` mudam)
